...
public static class Extensions
{
    ...
    public static WebApplication MapDefaultEndpoints(this WebApplication app)
    {
        ...
        // Required by orchestrators (Kubernetes, Azure Container Apps) for readiness probes.
        app.MapHealthChecks(HealthEndpointPath);

        // Only health checks tagged with the "live" tag must pass for app to be considered alive.
        // Required by orchestrators for liveness probes.
    ...
    public static TBuilder AddSerilogConfig<TBuilder>(this TBuilder builder) where TBuilder : IHostApplicationBuilder
    {
        var serilogBuilder = builder as WebApplicationBuilder;

        ArgumentNullException.ThrowIfNull(serilogBuilder);
